...
import { InsuranceDebtDetailComponent } from './activities-page/receipts-summary/insurances-debts-modal/insurance-debt-detail/insurance-debt-detail.component';
